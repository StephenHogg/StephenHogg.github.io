...
Turn it up to 11 if you find yourself deliberately glossing over any piece of evidence at your disposal because it conflicts with your understanding of your progress.[^4] As a rule, I generally tend to track a number of different metrics when training a model and look for situations where their results conflict. Loss going through floor but F1 going down with it?[^7] This incongruity is the sort of thing you want to know about, rather than disregarding one of these numbers because it doesn't fit a proposed explanation about the functioning of your model. Go hunting for a mess.
...
[^7]: The last time I saw this combination of evidence, it turned out a bias problem had gotten worse. This isn't a narrative fallacy, because I merely used this combination of factors as a prompt to search for explanations. Either of these metrics on its own would only tell you good versus bad without any context.
